...
export const SEMANTIC_ARTIFACT_READY = 'SEMANTIC_ARTIFACT_READY';
...
export const CORPUS_SEARCH = 'CORPUS_SEARCH';
export const PROBE_QUERY = 'PROBE_QUERY';
export const PROBE_SESSION_START = 'PROBE_SESSION_START';
export const PROBE_CHUNK = 'PROBE_CHUNK';
export const PROBE_COMPLETE = 'PROBE_COMPLETE';

// Attachments — local-first file uploads.
export const UPLOAD_ATTACHMENT = 'UPLOAD_ATTACHMENT';
export const LIST_ATTACHMENTS = 'LIST_ATTACHMENTS';
export const GET_ATTACHMENT_BLOB = 'GET_ATTACHMENT_BLOB';
export const DELETE_ATTACHMENT = 'DELETE_ATTACHMENT';
export const ATTACHMENT_STATUS_EVENT = 'ATTACHMENT_STATUS_EVENT';
