  ...
  async executeMappingStep(step, context, stepResults, workflowContexts, options) {
    ...
    const geometryPromise = (async () => {
      ...
      try {
        ...
        clusteringModule = await import('../../../clustering/index.js');
        const {
          generateEmbeddings,
        ...
        const { buildGeometricSubstrate, isDegenerate } =
          await import('../../../geometry/index.js');
        ...
        try {
          const { isDegenerate } = await import('../../../geometry/index.js');
