...
export default function App() {
  ...
  return (
    <div className="flex flex-col h-screen w-screen bg-app-gradient min-h-0">
        ...
        {isHistoryOpen && (
          <>
            <div
              ...
              onClick={closePanel}
            />
            <div ref={historyPanelRef} className="fixed top-0 left-0 w-[320px] h-screen z-[3000]">
      ...
      <ReconnectOverlay
        visible={
          isInitialized && !connectionStatus?.isConnected && connectionStatus?.hasEverConnected
        }
