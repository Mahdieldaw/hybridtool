...
export const BUILT_IN_COLUMNS: ColumnDef[] = [
  ...
  {
    id: 'sc_nearestClaimDistance',
    label: 'sc_dist',
    accessor: (r) => r.sc_nearestClaimDistance,
    type: 'number',
    format: fmtNum(3),
    sortable: true,
    groupable: false,
    description: 'Group distance to nearest claim for unclaimed statements',
    source: 'built-in',
    category: 'geometry',
  },
  {
