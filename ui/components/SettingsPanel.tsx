  ...
  return (
    ...
    >
      ...
      <div className="model-config">
        ...
        <h3 className="text-sm font-semibold text-text-brand mb-3 mt-0">Council Roles</h3>
        <div className="grid grid-cols-1 gap-3 mb-6">
          ...
          <div className="bg-chip border border-border-subtle rounded-lg p-3">
            <div className="flex items-center gap-2 mb-2 text-xs font-medium text-text-secondary">
              <span>🕳️</span>
              <span>Singularity (Synthesis)</span>
            </div>
            <select
        ...
        <div className="flex justify-between items-center mb-3">
          <h3 className="text-sm font-semibold text-text-brand m-0">Witness Models</h3>
            ...
            >
              <div className="model-info flex items-center gap-2">
                ...
                <div className="flex flex-col">
                  ...
                  {!isAuth && <span className="text-xs text-intent-danger">Login Required</span>}
                </div>
              </div>
              <div
        ...
        <h3 className="text-sm font-semibold mb-3 text-text-brand mt-5">Execution Mode</h3>
        <div className="mode-item flex items-center justify-between p-3 bg-chip border border-border-subtle rounded-lg mb-2">
          <span className="text-text-secondary">Run in Visible Tabs (for debugging)</span>
          <div
        ...
        <h3 className="text-sm font-semibold mb-3 text-text-brand mt-5">Advanced Features</h3>
        <div className="mode-item flex items-center justify-between p-3 bg-chip border border-border-subtle rounded-lg mb-2">
          <div className="flex flex-col">
        ...
        <h3 className="text-sm font-semibold mb-3 text-text-brand mt-5">Accessibility</h3>
        <div className="mode-item flex items-center justify-between p-3 bg-chip border border-border-subtle rounded-lg mb-2">
