...
export const BUILT_IN_COLUMNS: ColumnDef[] = [
  ...
  },
  {
    ...
    sortable: true,
    groupable: false,
    description: 'Claim absorption threshold (Layer B)',
    source: 'built-in',
    category: 'blast',
  },
  {
    id: 'bs_cascadeEcho',
    label: 'cascEcho',
    accessor: r => r.bs_cascadeEcho,
    type: 'number',
    format: fmtNum(3),
    sortable: true,
    groupable: false,
    description: 'Statement contribution to cascade exposure: sum(v_other / n_other) for shared claims',
    source: 'built-in',
    category: 'blast',
  },
...
export const DEFAULT_VIEWS: ViewConfig[] = [
  ...
  {
    id: 'blast-overlaps',
    label: 'Blast Overlaps',
    columns: ['statementId', 'text', 'model', 'bs_cascadeEcho'],
    sortBy: 'bs_cascadeEcho',
    sortDir: 'desc',
    groupBy: null,
    filter: [{ columnId: 'bs_cascadeEcho', op: '>', value: 0 }],
  },
  {
    id: 'routing',
    label: 'Routing',
