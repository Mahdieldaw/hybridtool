...
export const ClaimRibbon: React.FC<ClaimRibbonProps> = ({ artifact, focusedClaimId, onFocusClaim }) => {
          ...
          <button
            ...
            className={clsx(
              ...
              isActive
                ...
                : clsx('bg-white/5 border-white/10 text-text-secondary hover:bg-white/10 hover:text-text-primary'),
            )}
          >
            <span
              className={clsx(
