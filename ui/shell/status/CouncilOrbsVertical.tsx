...
export const CouncilOrbsVertical: React.FC<CouncilOrbsVerticalProps> = React.memo(() => {
  ...
  const contributingIds = useMemo(() => {
    ...
    return Array.from(new Set([...batchKeys, ...(mapperKey ? [mapperKey] : [])]));
  }, [turn]);
  ...
  return (
    <div
      className={clsx(
        'flex flex-col items-center gap-3 py-4 w-full transition-opacity duration-150',
    ...
    <div className="relative flex items-center justify-center w-full">
      <button
        ...
        className={clsx(
          ...
          isActive
            ? 'w-4 h-4 opacity-100 ring-2 ring-brand-500 ring-offset-2 ring-offset-surface-raised'
