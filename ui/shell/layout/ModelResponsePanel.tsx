...
import { EditorialDocument } from '../../reading/EditorialDocument';
...
import {
  formatBatchResponses,
  formatProviderResponseForMd,
} from '../../utils/copy-format-utils';
  ...
  ({ turnId, providerId, sessionId, onClose }) => {
    ...
    const displayContent = useMemo(() => {
      ...
      try {
        ...
        // Expected: text starting with { or [ may not be valid JSON.
        // Fall through and wrap as a json code block anyway.
      }
    ...
    const allBatchResponsesText = useMemo(() => {
      ...
      return formatBatchResponses(batch);
